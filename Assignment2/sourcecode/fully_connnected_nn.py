...
class FullyConnectedNN:
    ...
    def predict(self, X):
        ...
        Y = []
        for i in xrange(X.shape[1]):
            x = X[:,i]hidden_layer_size": [0.9705882352941176, 0.9705882352941176, 0.9705882352941176, 0.9705882352941176, 0.9705882352941176, 0.9705882352941176, 0.9705882352941176], "tol": [0.9705882352941176, 0.9705882352941176, 0.5588235294117647, 0.411764705882
            z_vecs = [x]
            a_vecs = [x]
            #forward
            for l in xrange(self._layer_sizes.shape[0]-1):
